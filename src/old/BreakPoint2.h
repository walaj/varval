...
namespace SnowTools2 {
 ...
 struct SampleInfo {
   ...
   std::pair<size_t, size_t> decoyed;
   ...
   std::string toValidatorFileString() const;
 ...
 struct BreakPoint {
   ...
   static std::string header() { 
     return "chr1\tpos1\tstrand1\tchr2\tpos2\tstrand2\tref\talt\tspan\tdisc_mapq1\tdisc_mapq2\tsub_n1\tsub_n2\thomology\tinsertion\tcontig\tconfidence\tevidence\tsecondary_alignment\tsomatic_score\tsomatic_lod\ttrue_lod\tpon_samples\trepeat_seq\tgraylist\tDBSNP\treads"; 
   }

   static std::string validator_header() { 
     return "id\tchr1\tpos1\tstrand1\tchr2\tpos2\tstrand2\thomology\tinsertion\treads"; 
   }
   ...
   */
   ...
   std::string toValidatorFileString(bool noreads = false);
